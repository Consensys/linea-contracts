...
contract PlonkVerifierFullLarge {
  ...
  uint256 private constant vk_ql_com_x = 6938680949263711887673260169396014451797548176075734235025198748070788264447;
  uint256 private constant vk_ql_com_y = 11517085978869356262581745618224896322557689249032650954473545930577223215839;
  uint256 private constant vk_qr_com_x = 20032234245560444799537114912709780719193536018425904339040906680061849800797;
  uint256 private constant vk_qr_com_y = 17639884340677639460323528528194956521321514910339454809791025576061310272214;
  uint256 private constant vk_qm_com_x = 5751624340906733211488566894078597516823364010145178297920001441907650547259;
  uint256 private constant vk_qm_com_y = 4925922492716523544587527699648712979255207363255114668230393695180554698473;
  uint256 private constant vk_qo_com_x = 12293472183682872424787620214396989195938727179873253098271233336643440014683;
  uint256 private constant vk_qo_com_y = 5333730229860167529882393243097945850182086234451075683183576545806324798181;
  uint256 private constant vk_qk_com_x = 14717485398954752633410353293611061833717995656434716841090814385092186835109;
  uint256 private constant vk_qk_com_y = 5065344902719624201902894127045692117386533816117672056168936255995435187474;

  uint256 private constant vk_s1_com_x = 3702220401003982986577455582909087018394826873467232694909446635640904002508;
  uint256 private constant vk_s1_com_y = 2159161983354128508421027832395235162973845823888296782451779260996513988616;

  uint256 private constant vk_s2_com_x = 19593621565355096633619134979642129542574908077597126916512111959525732557914;
  uint256 private constant vk_s2_com_y = 16141233598930216822421160018387797531454224694706076599454110060443165223205;

  uint256 private constant vk_s3_com_x = 20800456794739072165914329293597073586448534213038016085703395121688607891635;
  uint256 private constant vk_s3_com_y = 18817399691080727067652011126480375164051424816291409923642952541381051115708;

  uint256 private constant vk_coset_shift = 5;

  uint256 private constant vk_selector_commitments_commit_api_0_x =
    17522234271064211688159653487139801566034978696953223068299430486213443812084;
  uint256 private constant vk_selector_commitments_commit_api_0_y =
    2449763021123392100194544660410492335326664054251738404045217422457431942391;

  uint256 private constant vk_selector_commitments_commit_api_1_x =
    16474093098861280654577529656314678099751118956876693048453157337055959928473;
  uint256 private constant vk_selector_commitments_commit_api_1_y =
    4321263978984568446429908663986481031377551694468867306185400817952005957348;

  uint256 private constant vk_selector_commitments_commit_api_2_x =
    20364727173360824741174268594103174211335203633197467745950878023245370829441;
  uint256 private constant vk_selector_commitments_commit_api_2_y =
    18542969958877251082775339983068201431039663885869214190585436139793636213412;
