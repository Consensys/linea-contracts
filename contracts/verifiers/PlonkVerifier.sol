...
contract PlonkVerifier {
  ...
  function load_wire_commitments_commit_api(uint256[] memory wire_commitments, bytes memory proof) internal {
    assembly ("memory-safe") {
  ...
  function compute_ith_lagrange_at_z(uint256 zeta, uint256 i) internal returns (uint256) {
    uint256 res;
    assembly ("memory-safe") {
      // _n^_i [r]
  ...
  function compute_pi(bytes memory proof, uint256[] memory public_inputs, uint256 zeta) internal returns (uint256) {
  ...
  function Verify(bytes memory proof, uint256[] memory public_inputs) external returns (bool) {
    uint256 gamma;
    uint256 beta;
    uint256 alpha;
    uint256 zeta;
