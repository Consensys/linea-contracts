...
contract TestPlonkVerifierFullLarge is PlonkVerifierFullLarge {
  ...
  function get_proof() internal pure returns (bytes memory) {
    ...
    proof
      .proof_grand_product_commitment_x = 12339872535101791136938473104632960779515307705028256022488658950524364658084;
    proof
      .proof_grand_product_commitment_y = 13700775298119510228881610779758174609874110072969920663007732337589245836689;
    proof
      .proof_grand_product_at_zeta_omega = 8086255289888692594582872909191820127599563548142139264417744501084545665361;
    proof
      .proof_quotient_polynomial_at_zeta = 4063246400405234704251368205327407945392014053144225920715106055218028697468;
    proof
      .proof_linearised_polynomial_at_zeta = 4883144009090451872852175171081130403531667946283273738781089719918978395498;
    ...
    proof
      .proof_openings_selector_0_commit_api_at_zeta = 2226632238728408853167212228757853488525553436935017312668128210280683473999;

    proof
      .proof_openings_selector_1_commit_api_at_zeta = 16029466795172784635461850337043883795857826046824455184071283358602427409389;

    proof
      .proof_openings_selector_2_commit_api_at_zeta = 20472521693990187275721381445181449751569153360131762205932954989186873200210;

    proof
      .proof_selector_0_commit_api_commitment_x = 13861372597617737079461521156181487398794562135510566653835224958464741399174;
    proof
      .proof_selector_0_commit_api_commitment_y = 13047329560719662287794045802691494204831285096790325140825691905623145430542;

    proof
      .proof_selector_1_commit_api_commitment_x = 14366736071819467637501866926050762561546856106533892750479475015268832616312;
    proof
      .proof_selector_1_commit_api_commitment_y = 5571985744120853321982505798837005522701853156287851528519071004750645953835;

    proof
      .proof_selector_2_commit_api_commitment_x = 5404140837103247886692393207947357221344818249955296332520663445651808877206;
    proof
      .proof_selector_2_commit_api_commitment_y = 20606045694255945834048873983840581865287112270551969109076321801842168145823;
