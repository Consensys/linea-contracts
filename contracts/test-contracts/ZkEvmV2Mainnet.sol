...
// File contracts/interfaces/IL1MessageManager.sol
...
// File contracts/messageService/lib/Rlp.sol
...
// File contracts/messageService/lib/TransactionDecoder.sol
...
// File contracts/interfaces/IPlonkVerifier.sol
...
// File contracts/interfaces/IZkEvmV2.sol
...
// File contracts/messageService/lib/Codec.sol
 ...
 * @custom:security-contact security-report@linea.build
 */
contract ZkEvmV2Mainnet is IZkEvmV2, Initializable, AccessControlUpgradeable, L1MessageService {
  ...
  function _finalizeBlocks(
    ...
    for (uint256 i; i < _blocksData.length; ) {
      ...
      emit BlockFinalized(currentBlockNumberTemp, blockInfo.blockRootHash, _shouldProve);
